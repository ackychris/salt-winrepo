jre8:
  '8.0.1810.13':
    ...
    full_name: 'Java 8 Update 181 (64-bit)'
    installer: 'salt://win/repo-ng/jre8/jre-8u181-windows-x64.exe'
    uninstall_flags: '/qn /x {26A24AE4-039D-4CA4-87B4-2F64180181F0} /norestart'
    {% else %}
    full_name: 'Java 8 Update 181'
    installer: 'salt://win/repo-ng/jre8_x86/jre-8u181-windows-i586.exe'
    uninstall_flags: '/qn /x {26A24AE4-039D-4CA4-87B4-2F32180181F0} /norestart'
    {% endif %}
  ...
  '8.0.1710.11':
    {% if grains['cpuarch'] == 'AMD64' %}
    full_name: 'Java 8 Update 171 (64-bit)'
    installer: 'salt://win/repo-ng/jre8/jre-8u171-windows-x64.exe'
    uninstall_flags: '/qn /x {26A24AE4-039D-4CA4-87B4-2F64180171F0} /norestart'
    {% else %}
    full_name: 'Java 8 Update 171'
    installer: 'salt://win/repo-ng/jre8_x86/jre-8u171-windows-i586.exe'
    uninstall_flags: '/qn /x {26A24AE4-039D-4CA4-87B4-2F32180171F0} /norestart'
    {% endif %}
    install_flags: '/s REBOOT=Suppress SPONSORS=0'
    uninstaller: 'msiexec.exe'
    msiexec: False
